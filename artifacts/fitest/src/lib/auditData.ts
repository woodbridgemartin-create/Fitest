...
export const TIERS = [
  {
    ...
    bg: "bg-red-500/10",
    description: "Immediate intervention needed. Performance foundations are at risk and output is likely compromised.",
  },
  {
    name: "Exposed",
    min: 26,
    ...
    bg: "bg-amber-500/10",
    description: "Vulnerability present. Key pillars need attention to prevent further decline.",
  },
  {
    name: "Performing",
    min: 51,
    ...
    bg: "bg-lime-500/10",
    description: "A solid performing tier. Now it is about optimisation: recovery quality, stress mastery and the marginal gains that move you into Elite.",
  },
  {
    name: "Elite",
    min: 76,
    ...
    description: "Exceptional foundation. Sustain it, refine the edges, and set the standard for those around you.",
  },
];
